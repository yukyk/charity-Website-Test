...
} = require('../app/validators/charity.validator');
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.get('/:id', getCharityRules, validate, charityController.getCharity);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.post('/', verifyToken, createCharityRules, validate, charityController.createCharity);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.put('/:id', verifyToken, updateCharityRules, validate, charityController.updateCharity);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.post('/:id/projects', verifyToken, addProjectRules, validate, charityController.addProject);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.put('/:id/projects/:pid', verifyToken, updateProjectRules, validate, charityController.updateProject);
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.get('/:id/donations', verifyToken, charityDonationsRules, validate, charityController.getCharityDonations);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.post('/:id/impact-reports', verifyToken, addImpactReportRules, validate, charityController.addImpactReport);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.get('/:id/impact-reports', listImpactReportsRules, validate, charityController.listImpactReports);
