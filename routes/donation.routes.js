...
const donationController = require('../app/controllers/donation.controller');
const {
  createOrderRules,
  verifyPaymentRules,
  ...
  getDonationRules,
} = require('../app/validators/donation.validator');
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/create-order', verifyToken, createOrderRules, validate, donationController.createOrder);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.post('/verify-payment', verifyToken, verifyPaymentRules, validate, donationController.verifyPayment);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
// express.raw() applied here — NOT app-level express.json() — preserves raw body for signature verification (Error #15)
router.post('/webhook', express.raw({ type: 'application/json' }), donationController.razorpayWebhook);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/stripe/create-intent', verifyToken, createStripeIntentRules, validate, donationController.createStripeIntent);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/stripe/confirm', verifyToken, confirmStripePaymentRules, validate, donationController.confirmStripePayment);
 ...
 *         $ref: '#/components/responses/ValidationError'
 */
router.get('/:id', verifyToken, getDonationRules, validate, donationController.getDonation);
