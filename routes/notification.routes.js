...
const {
  ...
  markReadRules,
} = require('../app/validators/notification.validator');
 ...
 */
router.get('/', listNotificationsRules, validate, notificationController.listNotifications);
 ...
 */
router.put('/:id/read', markReadRules, validate, notificationController.markRead);
